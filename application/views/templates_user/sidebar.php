    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('dashboard/index') ?>">
                ...
                <div class="sidebar-brand-text mx-3">Marketplace Halal</div>
            </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('pembeli/dashboard/index') ?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Produk Herbal</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('dashboard/pembayaran') ?>">
                    <i class="fas fa-fw fa-table"></i>
