                            ...
                            <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                        ...
                                        <?php echo form_error('nomor_hp', '<div class="text-danger small ml-2">', '</div>' ) ?>
                                </div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="role_id" id="exampleRadios1" value="penjual" checked>
                                        <label class="form-check-label" for="exampleRadios1">
                                            Penjual
                                        </label>
                                </div>
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="role_id" id="exampleRadios2" value="pembeli">
